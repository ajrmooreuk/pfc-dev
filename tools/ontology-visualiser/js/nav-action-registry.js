...
export const ACTION_REGISTRY = {
  ...
  toggleProgrammeTrackerPanel:    () => window.toggleProgrammeTrackerPanel?.(),
  toggleDocumentRegisterPanel:    () => window.toggleDocumentRegisterPanel?.(),
  ...
  toggleSkeletonInspector: () => window.toggleSkeletonPanel?.(),
