...
| `PFC-DSY-STATUS-SlideDeck-Capability-VE-Summary.md` | RPT | DSY | [Epic 34 (#518)](https://github.com/ajrmooreuk/Azlan-EA-AAA/issues/518) | Active |
...
| Current Filename | Type | Location | Epic/Feature | Status |
|---|---|---|---|---|
| `.github/scripts/set-pat-all-triads.sh` | SCRIPT | `.github/scripts/` | [F61.5 / S61.5.1 (#947)](https://github.com/ajrmooreuk/Azlan-EA-AAA/issues/947) | Active |
| `.github/workflows/pat-drift-detection.yml` | WFL | `.github/workflows/` | [F61.5 / S61.5.2 (#947)](https://github.com/ajrmooreuk/Azlan-EA-AAA/issues/947) | Active |
| `RELEASE-BULLETIN-F61.5-PAT-Governance.md` | REL | `PBS/ARCHITECTURE/arch-cicd/` | [F61.5 (#947)](https://github.com/ajrmooreuk/Azlan-EA-AAA/issues/947) | Active |

### Workflow Updates (2026-03-08 — F61.6)

| Workflow | Change | Epic/Feature | Status |
|---|---|---|---|
| `validate-doc-naming.yml` | Tier-aware enforcement — blocks PFC- in PFI repos | [F61.6 (#962)](https://github.com/ajrmooreuk/Azlan-EA-AAA/issues/962) | Active |
| `guard-core.yml` | Added `guard-pfc-docs` job — PFC doc protection in PFI repos | [F61.6 (#962)](https://github.com/ajrmooreuk/Azlan-EA-AAA/issues/962) | Active |
| `pfc-release.yml` | Now distributes `validate-doc-naming.yml` to PFI triads | [F61.6 (#962)](https://github.com/ajrmooreuk/Azlan-EA-AAA/issues/962) | Active |
| `04-operating-guide.md` | v1.3.0 — PAT governance, drift detection, quick ref | [F61.5 (#947)](https://github.com/ajrmooreuk/Azlan-EA-AAA/issues/947) | Active |
...
| `PFC-DSY-BRIEF-Design-System-Maturity-Token-Gap-v1.0.0.md` | BRIEF | DSY | [Epic 61 (#876)](https://github.com/ajrmooreuk/Azlan-EA-AAA/issues/876) |
| `PFC-CICD-BRIEF-PBS-Architecture-DevSecOps-v1.0.0.md` | BRIEF | CICD | [Epic 61 (#947)](https://github.com/ajrmooreuk/Azlan-EA-AAA/issues/947) |
