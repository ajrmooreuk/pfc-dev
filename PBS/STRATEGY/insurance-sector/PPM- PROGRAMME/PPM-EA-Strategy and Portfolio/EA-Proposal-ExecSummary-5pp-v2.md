...
graph LR
    subgraph A["Prepare"]
        A1["Synthesise 5 audit<br/>workstreams"]
        A2["Stage workshop<br/>materials & demo"]
    end

    subgraph B["Workshop"]
        B1["1-Day EA Vision<br/>& Roadmap"]
        B2["Agree scope &<br/>commission design"]
    end

    subgraph C["Design Assignment"]
        C1["Discover →<br/>Design → Specify"]
        C2["21 artefacts<br/>delivered"]
    end
...
```mermaid
graph LR
    S1["Session 1<br/>The EA Model<br/>09:00–10:15"] --> S2["Session 2<br/>Where We Are<br/>10:30–11:45"]
    S2 --> S3["Session 3<br/>The Vision<br/>12:30–14:15"]
    S3 --> S4["Session 4<br/>The Roadmap<br/>14:30–15:30"]
    S4 --> S5["Session 5<br/>Agreement<br/>15:30–16:30"]

    style S1 fill:#1a3a5c,color:#fff
    style S2 fill:#2a4a6c,color:#fff
    style S3 fill:#0d4f4f,color:#fff
    style S4 fill:#3a2c5e,color:#fff
    style S5 fill:#4a2c6e,color:#fff
```
...
```mermaid
graph LR
    P1["Pillar 1<br/>Foundational<br/>Infrastructure<br/>──────────<br/>Enterprise Graph<br/>Data Governance<br/>Platform Security<br/>Process Catalogue"] --> P2["Pillar 2<br/>AI<br/>Augmentation<br/>──────────<br/>Virtual Agents<br/>Copilot Rollout<br/>Decision Support<br/>AI Governance"]
    P2 --> P3["Pillar 3<br/>Acceleration<br/>with Gen AI<br/>──────────<br/>Autonomous Workflows<br/>Predictive Analytics<br/>Real-Time Compliance<br/>70% STP"]
...
*EA-PPM-PT-2026-001-EP — EA Programme Executive Proposal v2.0*
*Classification: Internal — Commercial in Confidence*
